...
// این فایل برای ساخت تکست ادیتور صفحه اضافه کردن مقاله در پنل میباشد
...
const pasteLink = () => {
    ...
    pasteLinkBtn.addEventListener('click', () => {
        if (pasteLinkInput.value.match(myRegex)) {
            ...
            err.innerHTML = '<p class="red100">لطفا آدرس را وارد کنید</p>'
        } else {
            err.innerHTML = '<p class="red100">آدرس وارد شده غیر معتبر می باشد</p>'
        }
    })
}
// paste link validation and input
